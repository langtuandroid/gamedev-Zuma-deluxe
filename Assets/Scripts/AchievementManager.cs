...
public class AchievementManager
{
	...
	{
		return achievementList.Find((Achievement x) => x.id == id);
	}
	...
	{
		List<Achievement> list = achievementList.FindAll((Achievement x) => !x.reward.received);
	...
	public virtual void ReceiveReward(string achivementID)
	{
		...
		achievementList[index].reward.received = true;
		Reward(achievement);
