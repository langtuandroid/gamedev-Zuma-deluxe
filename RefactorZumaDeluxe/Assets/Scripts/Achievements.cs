...
public class Achievements
{
	...
	{
		string @string = SecurePlayerPrefs.GetString("achievement_" + id);
	...
	public void UpdateData()
	{
		for (int i = 0; i < achievements.Count; i++)
		{
			...
			{
				JSONNode jSONNode = JSON.Parse(SecurePlayerPrefs.GetString(key));
	...
	public void SaveAchievement(Achievement ach)
	{
		...
		SecurePlayerPrefs.SetString("achievement_" + ach.id, jSONClass.ToString());
