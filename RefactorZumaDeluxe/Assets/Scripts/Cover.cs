...
public class Cover : MonoBehaviour
{
	...
	{
		float width = UICameraControllerController.instance.GetWidth();
		float height = UICameraControllerController.instance.GetHeight();
		float virtualWidth = UICameraControllerController.instance.virtualWidth;
		float virtualHeight = UICameraControllerController.instance.virtualHeight;
		...
		float num3 = (!UICameraControllerController.instance.landscape) ? 800 : 400;
		float y = (!UICameraControllerController.instance.landscape) ? 400 : 800;
