...
public class CUtils
{
	...
	{
		if (!SecurePlayerPrefs.HasKey(action + "_time"))
		{
	...
	{
		SecurePlayerPrefs.SetDouble(action + "_time", GetCurrentTime());
	}

	public static double GetActionTime(string action)
	{
		return SecurePlayerPrefs.GetDouble(action + "_time");
	}

	public static BaseGameController GetGameController()
	{
		GameObject gameObject = GameObject.FindWithTag("GameController");
		return gameObject.GetComponent<BaseGameController>();
	}

	public static void SetLoggedInFb()
	{
		SecurePlayerPrefs.SetBool("logged_in_fb", value: true);
	}

	public static bool IsLoggedInFb()
	{
		return SecurePlayerPrefs.GetBool("logged_in_fb");
	}

	public static void SetBuyItem()
	{
		SecurePlayerPrefs.SetBool("buy_item", value: true);
	}

	public static void SetRemoveAds(bool value)
	{
		SecurePlayerPrefs.SetBool("remove_ads", value);
	}

	public static bool IsAdsRemoved()
	{
		return SecurePlayerPrefs.GetBool("remove_ads");
	}

	public static bool IsBuyItem()
	{
		return SecurePlayerPrefs.GetBool("buy_item");
	}

	public static void SetRateGame()
	{
		SecurePlayerPrefs.SetBool("rate_game", value: true);
	}

	public static bool IsGameRated()
	{
		return SecurePlayerPrefs.GetBool("rate_game");
	}

	public static void SetLikeFbPage(string id)
	{
		SecurePlayerPrefs.SetBool("like_page_" + id, value: true);
	}

	public static bool IsLikedFbPage(string id)
	{
		return SecurePlayerPrefs.GetBool("like_page_" + id);
	}
	...
	public static void SetAdmobAndroid(string id)
	{
		...
		{
			SecurePlayerPrefs.SetString("admob_android", id);
		}
	}
	...
	public static void SetVideoAdmobAndroid(string id)
	{
		if (!string.IsNullOrEmpty(id))
		{
			SecurePlayerPrefs.SetString("video_admob_android", id);
		}
	}
	...
	public static void SetVideoAdmobIOS(string id)
	{
		if (!string.IsNullOrEmpty(id))
		{
			SecurePlayerPrefs.SetString("video_admob_ios", id);
		}
	}

	public static string GetAdmobAndroid()
	{
		return SecurePlayerPrefs.GetString("admob_android");
	}
	...
	public static void SetAdmobIOS(string id)
	{
		if (!string.IsNullOrEmpty(id))
		{
			SecurePlayerPrefs.SetString("admob_ios", id);
		}
	}

	public static string GetAdmobIOS()
	{
		return SecurePlayerPrefs.GetString("admob_ios");
	}

	public static string GetVideoAdmobAndroid()
	{
		return SecurePlayerPrefs.GetString("video_admob_android");
	}

	public static string GetVideoAdmobIOS()
	{
		return SecurePlayerPrefs.GetString("video_admob_ios");
	}
	...
	public static void SetAdmobWP(string id)
	{
		if (!string.IsNullOrEmpty(id))
		{
			SecurePlayerPrefs.SetString("admob_wp", id);
		}
	}

	public static string GetAdmobWP()
	{
		return SecurePlayerPrefs.GetString("admob_wp");
	}

	public static void SetInitGame()
	{
		SecurePlayerPrefs.SetBool("init_game", value: true);
	}

	public static bool IsGameInitialzied()
	{
		return SecurePlayerPrefs.GetBool("init_game");
	}

	public static void SetAndroidVersion(string version)
	{
		SecurePlayerPrefs.SetString("android_version", version);
	}

	public static void SetIOSVersion(string version)
	{
		SecurePlayerPrefs.SetString("ios_version", version);
	}

	public static void SetWindowsPhoneVersion(string version)
	{
		SecurePlayerPrefs.SetString("wp_version", version);
	}

	public static string GetAndroidVersion()
	{
		return SecurePlayerPrefs.GetString("android_version", "1.0");
	}

	public static string GetIOSVersion()
	{
		return SecurePlayerPrefs.GetString("ios_version", "1.0");
	}

	public static string GetWindowsPhoneVersion()
	{
		return SecurePlayerPrefs.GetString("wp_version", "1.0");
	}

	public static void SetVersionCode(int versionCode)
	{
		SecurePlayerPrefs.SetInt("game_version_code", versionCode);
	}

	public static int GetVersionCode()
	{
		return SecurePlayerPrefs.GetInt("game_version_code");
	}
	...
	{
		float num = UICameraControllerController.instance.GetWidth() + padding;
		float num2 = UICameraControllerController.instance.GetHeight() + padding;
		return pos.x < 0f - num || pos.x > num || pos.y < 0f - num2 || pos.y > num2;
	}

	public static void SetNumofEnterScene(string sceneName, int value)
	{
		SecurePlayerPrefs.SetInt("numof_enter_scene_" + sceneName, value);
	}

	public static int GetNumofEnterScene(string sceneName)
	{
		return SecurePlayerPrefs.GetInt("numof_enter_scene_" + sceneName, 0);
	}
	...
	{
		SecurePlayerPrefs.SetInt("leaderboard_score", score);
	}

	public static int GetLeaderboardScore()
	{
		return SecurePlayerPrefs.GetInt("leaderboard_score");
	}
	...
	{
		SecurePlayerPrefs.SetInt("auto_sign_in_gps", value);
	}

	public static int GetAutoSigninGPS()
	{
		return SecurePlayerPrefs.GetInt("auto_sign_in_gps");
	}
